...
<section class="diginto businessMain container-fluid text-center">

    <h1 class="d-green">OUR BUSINESS</h1>
...
<section class="container-fluid">
    <div class="position-relative fullwidth mx-auto early-generation row justify-content-between" id="earlygeneration">
<div class=" col-md-6">
<img src={process.env.PUBLIC_URL + "images/diroto1.webp"} alt="" class="onion-roots" />
            </div>
            <div class="col-md-6 d-flex flex-column gap-4 " >
                <h1 class="d-green">Early Generation Seed Potatoes</h1>
                ...
                <div class="d-flex flex-row  gap-5 seed-container justify-content-between d-none">
    ...
    <div class="position-relative fullwidth mx-auto early-generation pt-5 row justify-content-between" id="Commercialpotatos">
<div class=" col-md-6">
<img src={process.env.PUBLIC_URL + "images/diroto2.webp"} alt="" class="tree-roots"  />
</div>
            <div class="col-md-6 d-flex flex-column gap-4 ">
                <h1 class="d-green">Commercial Potatoes</h1>
