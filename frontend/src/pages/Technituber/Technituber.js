...
<section className="section1 container-fluid mx-auto position-relative">
        ...
        <div className="fullwidth mx-auto row align-items-center">
          <div className="col-lg-6 d-flex flex-column">
            ...
            <h1 className='d-green'>TECHNITUBER® Seed</h1>
            <p>
      ...
      <section className="aachar container-fluid position-relative justify-content-center">
        ...
        <div className="fullwidth mx-auto row justify-content-center align-items-center">
          ...
          <div className="col-lg-7 aachar-container">
            <h1 className="d-green">Special Features</h1>
            <p className="mb-5">-	The TECHNITUBER® seed produces tubers of different sizes ranging from 12-15, 15-18 and 18-20 mm and weighing approximately 1.2-2.0 grams, good enough to plant @ approximately 90-100 kg per Hectare. </p>
            <p className="mb-5">-	The TECHNITUBER® seeds are delivered pre-sprouted in ‘field ready’ conditions and are easily transported. </p>
            <p className="mb-5">-	The high health status of the TECHNITUBER® seed allows for disease quarantine regulations of different countries to be easily met and the compact size avoids the wasted costs incurred in storage and transport of much larger seed pieces.</p>
            <p className="mb-5">-	Technico has also forged strong relationship with Speciality growers, Breeder and Variety owners across the Globe to produce proprietary varieties with large germplasm bank ({'>'} 250 varieties).</p>
            <h2> Certification</h2>
      ...
      <section className="section3 container-fluid position-relative mx-auto">
        <div className="fullwidth mx-auto row align-items-center justify-content-center">
          <div className="col-lg-6">
            ...
            <h1 className="d-green">Grow Your Own Seed Cost</h1>
      ...
      <section className="container-fluid position-relative section-middle">
        ...
        <div className="col-md-6">
          ...
          <div className="col-lg-6 ps-4">
            ...
            <h1 className="d-green">Catering to Global Markets</h1>
